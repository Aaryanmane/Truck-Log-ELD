...
- [Deployment](#deployment-to-rendercom)
...
3. Select your GitHub repo: `Truck-Log-ELD`
4. Configure:
   - **Name:** `truck-eld-backend`
   - **Build Command:**
     ```
   ...
   - **Start Command:**
     ```
     cd backend && gunicorn truck_eld_project.wsgi:application
     ```
...
5. Add Environment Variables:
   ...
   DEBUG=False
   ALLOWED_HOSTS=truck-eld-backend.onrender.com
   CORS_ALLOWED_ORIGINS=https://truck-eld-frontend.onrender.com
   EMAIL_HOST_USER=your-email@gmail.com
   EMAIL_HOST_PASSWORD=<gmail-app-password>
   ```

6. Create PostgreSQL database at bottom
7. Click **Create Web Service**
8. Wait 2-3 minutes → Copy live URL
...
4. Add Environment Variables:
   ```
   NODE_ENV=production
   VITE_API_BASE_URL=https://truck-eld-backend.onrender.com
   ```

5. Click **Create Web Service**
6. Wait 5-10 minutes → Copy live URL

### Step 3: Update Backend CORS

1. Go to **truck-eld-backend** service → **Environment**
2. Edit `CORS_ALLOWED_ORIGINS`:
   ```
   https://truck-eld-frontend.onrender.com,http://localhost:5173
   ```
...
4. Select: Gmail + Windows Computer
5. Copy 16-character password
6. Paste into `EMAIL_HOST_PASSWORD` in Render
